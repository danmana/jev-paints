...
export const LAYOUTS: Layout[] = [
  ...
  },
  {
    id: 'portrait_bust',
    name: 'Portrait bust',
    description: 'a head and shoulders filling the canvas, background behind',
    regions: [
      r('background', 'background', 'everything behind the figure', FULL),
      r('shoulders', 'shoulders and torso', 'the lower half where shoulders and chest sit', [0.08, 0.55, 0.92, 1]),
      r('head', 'head', 'the oval of the head in the upper middle', [0.3, 0.1, 0.7, 0.58]),
      r('face', 'face', 'the centre of the head where the features are', [0.37, 0.22, 0.63, 0.52]),
      r('hair', 'hair or top of head', 'the top of the head and above', [0.24, 0.03, 0.76, 0.35]),
    ],
    phases: [
      ph('background', 'the background', 0.2),
      ph('shoulders', 'shoulders and torso', 0.15),
      ph('head', 'the head shape and hair', 0.3),
      ph('face details', 'features of the face', 0.25),
